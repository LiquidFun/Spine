...
from spine.datasets.sample import GTFormat, MetadataSample, MetadataTypes, get_pid_to_index_lookup
from spine.datasets.segmentation_dataset import get_potential_data_dirs
from spine.resources.paths import NAKO_DATASET_PATH
...
def mean_prediction():
    ...
    from spine.resources.preloaded import get_measure_statistics
