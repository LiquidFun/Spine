...
from spine.datasets.sample import SampleIterator, get_random_crop_slice
from spine.inference.onnx_model import ONNXInferenceModel
from spine.instance_separation.instance_separation import (
    get_planes_from_rois,
    mask_rare_rois,
    separate_rois_with_labels,
    separate_segmented_rois_by_planes,
)
from spine.plotting.plot_slice import get_stats, plot_npz, single_plot
from spine.resources.paths import RAW_NAKO_DATASET_PATH, TRAIN_SPLIT_CSV_PATH, VAL_SPLIT_CSV_PATH
from spine.spine_types.labels import get_labels_for_n_classes
from spine.utils.log_dir import get_next_log_dir
...
from spine.datasets.segmentation_dataset import SegmentationDataModule, expand_path_to_data_dirs
...
def post_process_instances(vertebra_instances, segmentation, plot_dir=None):
    ...
    if plot_dir is not None:
        ...
        from spine.visualisation.color_palettes import get_alternating_palette
