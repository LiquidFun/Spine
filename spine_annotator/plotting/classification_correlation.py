...
from spine_annotator.annotators.vector_annotator import VectorAnnotator
from spine_annotator.resources.paths import PLOTS_PATH
from spine_annotator.resources.preloaded import get_measure_statistics
